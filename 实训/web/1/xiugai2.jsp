        ...
        <td rowspan="2">
            <form action="../UpdateServlet2" method="post">
                <table align="center" class="auto-style11">
                    <tr>
                        <td class="auto-style15" colspan="2">修改界面2</td>
                    </tr>
                    <tr>
                        <td class="auto-style13">编号：</td>
                        <td>
                            <input id="Text1" class="auto-style16" type="text" name="id" value="${id}" readonly="true"/></td>
                    </tr>
                    <tr>
                        <td class="auto-style13">账号：</td>
                        <td>
                            <input id="Text2" class="auto-style16" type="text" name="username" value="${username}"/></td>
                    </tr>
                    <tr>
                        <td class="auto-style13">密码：</td>
                        <td>
                            <input id="Text3" class="auto-style16" type="text" name="password" value="${password}"/></td>
                    </tr>

                    <tr>
                        <td class="auto-style14" colspan="2">
                            <input id="Submit1" class="auto-style16" type="submit" value="确  定" />
                            <br><br>
                            ${errormsg}
                        </td>
                    </tr>
